        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          >
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Creating engaging digital experiences with cutting-edge web technologies. 
              Let's bring your ideas to life with beautiful design and smooth interactions.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-primary/20 flex items-center justify-center transition-colors text-white">
          ...
          >
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">hello@example.com</li>
              <li className="text-gray-300">+1 (123) 456-7890</li>
              <li className="text-gray-300">New York, NY, USA</li>
            </ul>
          </motion.div>
        </div>
